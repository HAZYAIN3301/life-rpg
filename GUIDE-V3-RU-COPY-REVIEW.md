...
## Формулировки, требовавшие отдельного решения — ✅ решено 2026-08-24 и сверено для v193
...
- `context.pets.prompt` — в v193 исправлено на фактическую связь питомца со сферой без диагноза «недостатка внимания»; completion требует реального открытия подсказки.
- `context.stats.prompt` — в v193 переименовано в «Прогресс» и привязано к meaningful surface после семи разных дней данных; пустой экран не закрывает главу.
