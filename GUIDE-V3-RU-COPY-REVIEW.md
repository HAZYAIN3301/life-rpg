...
> и должен быть доступен в обычном приложении. Флаг включает RU-runtime; переводы остаются
> отдельным integration-гейтом.
> Runtime gate: `GuideV3CopyRu.RUNTIME_APPROVED === true`.
