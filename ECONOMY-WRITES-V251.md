...
**Продолжение v253:** [FEATURE-WRITES-V253.md](./FEATURE-WRITES-V253.md).
Серверный общий каталог/проверка цены и сохранённого баланса, запрет переписывать историю
через economy endpoint; durable Notes/Calendar/Habits и настройки Логова/званий.
Остаток ниже описывает v251/v252: эти пункты теперь уточнены v253, не весь P0 закрыт.
