...
Аватарный трек обновлён 2026-09-07: [AVATAR-3D-PILOT-V1.md](./AVATAR-3D-PILOT-V1.md).
3D пока только в фабрике; runtime checkpoint ниже этим не меняется.

## Актуальный handoff — 2026-09-06

Дизайн-трек 2026-09-07: [DESIGN-REBOOT-V1.md](./DESIGN-REBOOT-V1.md).
Изолированное интерактивное desktop-превью Today и план дальнейших экранов.
Новая оболочка НЕ установлена в runtime. После просмотра приняты спокойствие/читаемость;
следующий gate — характер крупных элементов и полноценный mobile, не весь app сразу.
