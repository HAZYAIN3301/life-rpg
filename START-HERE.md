...
Изолированное интерактивное A/B-превью Today для desktop/mobile и план дальнейших экранов.
Новая оболочка НЕ установлена в runtime. Спокойствие/читаемость исходника приняты;
следующий gate — выбор пользователя между новыми A/B, не весь app сразу.
