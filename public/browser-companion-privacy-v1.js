(function () {
  ...
  "en": {
    ...
    "language": "Language",
    "back": "Installation",
    "date": "Updated 26 September 2026 · Extension 0.9.0",
  ...
  "ru": {
    ...
    "language": "Язык",
    "back": "Установка",
    "date": "Обновлено 26 сентября 2026 · Расширение 0.9.0",
  ...
  "de": {
    ...
    "language": "Sprache",
    "back": "Installation",
    "date": "Aktualisiert am 26. September 2026 · Erweiterung 0.9.0",
  ...
  "uk": {
    ...
    "language": "Мова",
    "back": "Установлення",
    "date": "Оновлено 26 вересня 2026 · Розширення 0.9.0",
    ...
    "local": "Локальне сховище розширення містить правила, вибрані імена сайтів, сценарії входу, денні бюджети, паузи, відкладені зміни, бюджет аварійного доступу, поточну сесію та до 100 мінімальних підсумків сесій. Поточна сесія може містити введені тобою деталі завдання, тему й очікуваний результат. Причини аварійного доступу перевіряються під час дії та не зберігаються вільним текстом. З версії 0.9.0 там також зберігаються замок захисту (початок і залишок часу), кількість заблокованих спроб за сьогодні (лише число, без адрес) і причини, які ти вписав для сторінки блокування.",
    "addressesTitle": "Як використовуються адреси сайтів",
    "addresses": "Розширення обробляє дозволені адреси для застосування межі або фільтра. Адреса спроби входу може ненадовго залишитися в пам’яті, щоб повернути тебе на ту саму сторінку. Журнал відвідувань не зберігається; розширення не читає базу історії браузера, cookie, назви сторінок, переглянуті матеріали чи дані входу. Коли ввімкнено категорію «18+», на reddit.com розширення запитує в самого Reddit (його about.json), чи позначено відкриту або показану в стрічці спільноту чи профіль як 18+. Відповідь зберігається в локальному сховищі розширення до 7 днів; до Satoru нічого не надсилається.",
  ...
  "es": {
    ...
    "language": "Idioma",
    "back": "Instalación",
    "date": "Actualizado el 26 de septiembre de 2026 · Extensión 0.9.0",
    ...
    "local": "El almacenamiento local de la extensión contiene reglas, nombres de sitios configurados, escenarios de entrada, presupuestos diarios, pausas, cambios pendientes, presupuesto de acceso de emergencia, sesión activa y hasta 100 resultados mínimos de sesiones. La sesión activa puede incluir los detalles de la tarea, el tema y el resultado esperado que introduzcas. Los motivos de emergencia se comprueban al actuar y no se guardan como texto libre. Desde la 0.9.0 también guarda el candado de protección (inicio y tiempo restante), el número de intentos bloqueados de hoy (solo un número, sin direcciones) y las razones que escribes para la página de bloqueo.",
    "addressesTitle": "Cómo se usan las direcciones",
    "addresses": "La extensión procesa las direcciones autorizadas para aplicar un límite o una regla de contenido. Puede mantener brevemente en memoria una dirección de entrada para volver a la misma página. No guarda un registro de navegación ni lee la base de datos del historial, cookies, títulos de páginas, contenidos vistos o credenciales de cuentas. Con la categoría 18+ activa, en reddit.com la extensión consulta el about.json del propio Reddit para saber si una comunidad o perfil que abres o ves en el feed está marcado como 18+. La respuesta se guarda en el almacenamiento local de la extensión hasta 7 días; no se envía nada a Satoru.",
