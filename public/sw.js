...
const CACHE = 'satoru-v171';
const SHELL = [
  './', 'index.html', 'app.js', 'goals-initiatives-v1.js', 'guide-v3.js', 'guide-v3-copy-ru.js', 'guide-presenter-v1.js', 'guide-surface-v1.js', 'canon-domains.js', 'den-stage-v1.js', 'den-life-v1.js', 'den-resident-life-v1.js', 'den-pet-pair-v1.js', 'body-toad-v1.js', 'recovery-slug-v1.js', 'resources-penguin-v1.js', 'profile-memory-v1.js', 'day-observation-v1.js', 'stuck-task-v1.js', 'fights-v1.js', 'board-v1.js', 'board-v2.js', 'board-v2-catalog.js', 'board-v2-pacing.js', 'board-v2-offers.js', 'board-v2-completion.js', 'board-v2-issuer.js', 'board-v2-runtime.js', 'board-pool-v1.js', 'board-taste-v1.js', 'failure-context-v1.js', 'after-lapse-v1.js', 'chest-reveal-v1.js', 'sphere-search-v1.js', 'chart-labels-v1.js', 'md-lite-v1.js', 'voice-input-v1.js', 'sky-events-v1.js', 'day-load-v1.js', 'traveller-appearance-v1.js', 'traveller-motion-v3.js', 'traveller-room-v4.js', 'styles.css', 'fonts/podkova/Podkova-wght.woff2', 'shadow-rig-v2.js', 'shadow-den-v1.js', 'shadow-voice-v2.js', 'shadow-rig-v2-demo.html', 'den-scene-v4.js',
