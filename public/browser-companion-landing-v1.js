(function browserCompanionLanding() {
  ...
  const BROWSERS = Object.freeze({
    chrome: { name: 'Chrome', address: 'chrome://extensions', package: 'downloads/satoru-attention-chromium-v299.zip', step: 'step3Chromium' },
    edge: { name: 'Microsoft Edge', address: 'edge://extensions', package: 'downloads/satoru-attention-chromium-v299.zip', step: 'step3Chromium' },
    brave: { name: 'Brave', address: 'brave://extensions', package: 'downloads/satoru-attention-chromium-v299.zip', step: 'step3Chromium' },
    ...
    opera: { name: 'Opera', address: 'opera://extensions', package: 'downloads/satoru-attention-chromium-v299.zip', step: 'step3Chromium' },
    vivaldi: { name: 'Vivaldi', address: 'vivaldi://extensions', package: 'downloads/satoru-attention-chromium-v299.zip', step: 'step3Chromium' },
