...
(function exposeGuideV3CopyUk(root, factory) {
  ...
  const COPY = Object.freeze({
    ...
    "context.tree.prompt": "У тебе є очко навички. Воно може відкрити доступний вузол із заздалегідь указаним бонусом. Спочатку подивись: вибір вузла не витрачає очко.",
    "context.tree.complete": "Тепер видно, що дасть вузол і скільки він коштує. Очко витратиться лише після окремого підтвердження відкриття.",
