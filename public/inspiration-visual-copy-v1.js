...
(function(root, factory) {
  ...
  const rows = [
    ...
    ['Поиск новых находок сейчас не подключён. Доступна подборка из просмотренных материалов.','Discovery search is not connected yet. A selection from reviewed materials is available.','Die Suche nach neuen Fundstücken ist noch nicht verbunden. Eine Auswahl aus gesichteten Inhalten ist verfügbar.','Пошук нових знахідок поки не підключено. Доступна добірка з переглянутих матеріалів.','La búsqueda de novedades aún no está conectada. Hay una selección de materiales revisados.'],
