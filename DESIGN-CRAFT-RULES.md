...
> **Уточнение приоритета — 2026-09-07, прямое требование Альберта.**
> Ограничение количества акцентов/кнопок (в том числе SD-04) не является разрешением
> прятать частые действия. Голосовой итог, время начала, длительность и выполнение
> должны находиться без поиска под «ещё». Перед чисткой составить список сохраняемых
> действий; после — пройти его в браузере. Число удалённых слов/рамок не критерий успеха.
> Статус эксперимента и следующие gates: [DESIGN-REBOOT-V1.md](./DESIGN-REBOOT-V1.md).
> Экспериментальные tokens/layout нельзя молча переносить на остальные экраны.
