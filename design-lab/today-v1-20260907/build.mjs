...
const assets={
  ...
  'den-day.jpg':'art/den/v5/den-day.jpg',
  'nav-today.svg':'art/icons/ui/nav-today.svg',
  'nav-plan.svg':'art/icons/ui/nav-plan.svg',
  'nav-habits.svg':'art/icons/ui/nav-habits.svg',
  'nav-notes.svg':'art/icons/ui/media-notes.svg',
  'nav-inspiration.svg':'art/icons/ui/nav-skills.svg',
  'nav-hero.svg':'art/icons/ui/nav-hero.svg',
  'nav-tribe.svg':'art/icons/ui/nav-tribe.svg',
  'nav-profile.svg':'art/icons/ui/nav-settings.svg',
  'nav-rewards.png':'art/icons/emblems/system-rewards-chest-v2.png',
