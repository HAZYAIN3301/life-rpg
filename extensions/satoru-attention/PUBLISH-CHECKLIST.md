# Satoru Attention v212 — signed store publication checklist
...
- Chrome Web Store: `public/downloads/satoru-attention-chrome-store-v212.zip`
- Microsoft Edge Add-ons: `public/downloads/satoru-attention-edge-store-v212.zip`
- Opera Add-ons: `public/downloads/satoru-attention-opera-store-v212.zip`
- Brave and Vivaldi use the Chrome Web Store listing; the manual Chromium test package is
  `public/downloads/satoru-attention-chromium-v212.zip`.
...
Upload `public/downloads/satoru-attention-firefox-amo-v212.zip`. The generated manifest uses
...
Upload `public/downloads/satoru-attention-safari-app-store-v212.zip` to Safari Web Extension
