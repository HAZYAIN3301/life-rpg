# Satoru Attention v213 — signed store publication checklist
...
- Chrome Web Store: `public/downloads/satoru-attention-chrome-store-v213.zip`
- Microsoft Edge Add-ons: `public/downloads/satoru-attention-edge-store-v213.zip`
- Opera Add-ons: `public/downloads/satoru-attention-opera-store-v213.zip`
- Brave and Vivaldi use the Chrome Web Store listing; the manual Chromium test package is
  `public/downloads/satoru-attention-chromium-v213.zip`.
...
Upload `public/downloads/satoru-attention-firefox-amo-v213.zip`. The generated manifest uses
...
Upload `public/downloads/satoru-attention-safari-app-store-v213.zip` to Safari Web Extension
