...
for(const file of ['traveller.html','traveller.css','traveller.mjs','traveller-rig.mjs'])await copyFile(file,'dist/'+file);
...
inputs.push('traveller.html','traveller.css','traveller.mjs','traveller-rig.mjs');
const hashes={};
