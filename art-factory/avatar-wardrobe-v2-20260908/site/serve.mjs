...
export function createPreviewServer(){
 return http.createServer(async(req,res)=>{
  try{
   ...
   else if(!['index.html','workbench.css','workbench.mjs','wardrobe.mjs','contract.mjs','drawn.html','drawn.css','drawn.mjs','drawn-rig.mjs','volume.html','volume.css','volume.mjs','volume-rig.mjs','traveller.html','traveller.css','traveller.mjs','traveller-rig.mjs'].includes(name))throw Error('Private');
