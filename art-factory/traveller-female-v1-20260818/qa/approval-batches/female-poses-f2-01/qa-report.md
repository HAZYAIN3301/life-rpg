# Traveller female v1 — QA: `female-poses-f2-01`
...
|---|---:|---:|---:|---:|
| `arms-up` | `[640, 900]` | `[183, 31, 457, 860]` | `0.000000%` | PASS |
...
Contact sheet: `previews/approval-batches/female-poses-f2-01/contact-sheet.png`.
