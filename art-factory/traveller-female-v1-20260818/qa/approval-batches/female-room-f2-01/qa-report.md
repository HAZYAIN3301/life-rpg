# Traveller female v1 — QA: `female-room-f2-01`
...
|---|---:|---:|---:|---:|
| `bench-read-a` | `[640, 900]` | `[107, 70, 532, 860]` | `0.000000%` | PASS |
...
Contact sheet: `previews/approval-batches/female-room-f2-01/contact-sheet.png`.
