# Traveller female v1 — QA: `female-poses-01`
...
|---|---:|---:|---:|---:|
| `arms-up` | `[640, 900]` | `[141, 31, 498, 860]` | `0.000000%` | PASS |
...
Contact sheet: `previews/approval-batches/female-poses-01/contact-sheet.png`.
