...
test('Account profile v209 client: preview, layouts, privacy and social entry points are wired', () => {
  assert.match(HTML, /account-profile-v1\.js\?v=20260830-account-profile-v209-1[^]*app\.js\?v=20260925-screens-v287-1/);
  assert.match(HTML, /styles\.css\?v=20260925-screens-v287-1/);
  assert.match(SW, /const CACHE = 'satoru-v287'/); assert.match(SW, /account-profile-v1\.js/);
