...
test('Account profile v209 client: preview, layouts, privacy and social entry points are wired', () => {
  assert.match(HTML, /account-profile-v1\.js\?v=20260830-account-profile-v209-1[^]*app\.js\?v=20260909-design-v250-1/);
  assert.match(HTML, /styles\.css\?v=20260908-design-v248-1/);
  assert.match(SW, /const CACHE = 'satoru-v250'/); assert.match(SW, /account-profile-v1\.js/);
