...
test('new authored Calendar copy is complete in all supported locales', () => {
  for (const key of [
    ...
    'Это сложный квест. Честный ответ влияет на XP и твою энергию.',
    'Через силу', 'расход энергии ×1,5', 'Нормально', 'обычные XP и энергия',
    'В кураже!', 'Хайп · расход энергии ниже',
    'Воля против сопротивления истощает сильнее (ego depletion), поток — меньше (flow). Поэтому здоровая середина устойчивее, чем вечный форсаж.',
  ]) {
