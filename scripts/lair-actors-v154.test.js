...
test('v167 shell revision and cache-busting are coherent', () => {
  ...
  assert.match(sw, /const CACHE = 'satoru-v177'/);
  ...
  assert.match(index, /styles\.css\?v=20260826-launch-hardening-v177-1/);
  assert.match(index, /app\.js\?v=20260826-launch-hardening-v177-1/);
