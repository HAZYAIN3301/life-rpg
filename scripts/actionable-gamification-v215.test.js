...
test('v215 integrity modules remain ordered while v216 advances the app shell', () => {
  ...
  assert.match(SW, /const CACHE = ['"]satoru-v230['"]/, 'service-worker cache must be bumped to satoru-v230');
  ...
  assert.match(APP, /const PWA_CACHE_VERSION = ['"]satoru-v230['"]/, 'app and service worker disagree on the v216 cache');
