...
test('v215 integrity modules remain ordered while the app shell advances to v248', () => {
  ...
  assert.match(SW, /const CACHE = ['"]satoru-v268['"]/, 'service-worker cache must be bumped to satoru-v268');
  ...
  assert.match(APP, /const PWA_CACHE_VERSION = ['"]satoru-v268['"]/, 'app and service worker disagree on the v248 cache');
